          ...
          <div className="mx-auto max-w-[1200px] min-h-screen px-5 lg:px-8">
            ...
            <div className="flex items-center justify-center h-96">
              <div className="text-center">
                <div className="text-[#9CA3AF] text-lg mb-2">Movie not found</div>
                <div className="text-[#6B7280] text-sm">The requested movie could not be found</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="relative mt-2 bg-gradient-to-b from-gray-900 via-gray-900 to-[#111827]">
          {bg && (
            <div className="absolute inset-0 opacity-40">
              <Image src={bg} alt={data.title} fill className="object-cover" />
            </div>
          )}
          <div className="relative z-10 max-w-[1200px] mx-auto px-5 lg:px-8 py-12 md:py-20 flex flex-col lg:flex-row gap-8 items-end lg:items-stretch">
            ...
            <div className="text-white flex flex-col justify-center md:justify-end w-full">
              <p className="text-sm text-gray-300 tracking-wider">
                {releaseYear && <span>{releaseYear}</span>} {typeof hours === "number" && typeof minutes === "number" && (
                      ...
                      {director && (
                        <div>
                          <div className="flex items-center">
                            ...
                            <div>
                              <p className="font-semibold text-gray-600">Director</p>
                        ...
                        <div>
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{new Date(data.release_date).toLocaleDateString(undefined, { year: "numeric", month: "long", day: "numeric" })}</p>
                            </div>
                          </div>
                          <div className="border-t border-gray-200 my-2" />
                        </div>
